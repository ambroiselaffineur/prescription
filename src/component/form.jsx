    ...
    return (
      <Form onSubmit={this.props.onSubmit} onChange={this.props.onChange}>
        ...
        <ul>
          ...
          <li>Le <mark>rapport oro-génital</mark> consiste à mettre en contact le sexe d'une personne, et la bouche d'une autre personne (action de lécher, d'embrasser, etc). Attention, en cas de pénétration, cochez la case pénétration. Le rapport bucco-génital est considéré comme un viol depuis la réforme du 21 avril 2021. Les rapports bucco-génitaux sans pénétration commis avant cette dates seront qualifiés d'agression sexuelle.</li>
        </ul>
        On distinguera le cas où l'acte de pénétration a été commis sur la personne de l'auteur (par exemple : une personne pratique une fellation sur une victime non consentante), ou sur la personne de la victime (cas le plus courant, c'est alors la victime qui est visée par l'acte de pénétration). Depuis la réforme du 6 août 2018 portant notamment modification de l'article 222-23 du code pénal, l'acte de pénétration commis sur la personne de l'auteur est constitutif du crime de viol. Avant cette date, les faits doivent être qualifiés d'agression sexuelle.
        </div>
        <Form.Group className="mb-3" controlId="natureActe">
